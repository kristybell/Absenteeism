...
class CustomScaler(BaseEstimator, TransformerMixin):
    ...
    def __init__(slef,columns,copy=True, with_mean=True, with_std=True):
    ...
    def fit(self,X, y=None):
        ...
        self.mean = np.array(np.mean(X[self.columns]))
...
class absenteeism_model():
        ...
        def load_and_clean_data(self, data_file):
            ...
            # create a separate dataframe, contraining dummy values for ALL available reasons
            ...
            column_names = ['Date', 'Transportation Expense', 'Distance to Work', 'Age', 
                            ...
                            'Children','Pet', 'Absenteeism Time in Hours', 'Reason_1', 'Reason_2', 'Reason_3', 'Reason_4']
            ...
            df = df.drop(['Day of the Week', 'Daily Work Average', 'Distance to Work'], axis=1)
...
# The Module Consists of 5 Methods:
# 1. __init__
